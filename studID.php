...
<html>
  ...
  <body style="background-image: url('footerBg.png');background-size: 100%;">
    ...
    <form class="theForm" action="studID_final.php" method="post">
      <div class="">
      ...
      <div class="bodyContent">
        <div class="container">
          <h3 style="text-align:center;">Let's Generate your Student ID</h3><br>
          <table class="table" width="100%">
            <tr>
              <th><label for="studUsr">First Name: </label></td>
              <td><input type="text" class="form-control" name="studfName" required="required"></td>
            </tr>
            <tr>
              <th><label for="studUsr">Middle Name: </label></td>
              <td><input type="text" class="form-control" name="studmName"></td>
            </tr>
            <tr>
              <th><label for="studUsr">Last name: </label></td>
              <td><input type="text" class="form-control" name="studlName" required="required"></td>
            </tr>
            <tr>
              <th><label for="studUsr">Student Number: </label></td>
              <td><input type="text" class="form-control" name="studNumber" required="required"></td>
            </tr>
            <tr>
              <th><label for="studUsr">Sex: </label></td>
              <td>
            ...
            <tr>
              <th><label for="studUsr">Level: </label></th>
              <td>
